package org.ventura.soluciones.sunatws.gr.factory.impl;
...
import org.ventura.soluciones.sunatws.gr.client.production.ProductionGRClient;
import org.ventura.soluciones.sunatws.gr.client.test.TestGRClient;
...
public final class SunatClientFactoryImpl extends SunatClientFactory {
    ...
    public ISunatClient getSunatClient(String clientName, String documentType) throws ConfigurationException {
        ...
        if (clientName.equalsIgnoreCase(ISunatConfig.TEST_CLIENT)) {
            ...
            sunatClient = new ProductionGRClient();
            if (logger.isInfoEnabled()) {
