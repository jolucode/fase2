 ...
 * de HOMOLOGACION.
 *
 * @author Yosmel Lopez Pimentel (yosmellopez@gmail.com)
 */
public interface IVenturaError {
    ...
    ErrorObj ERROR_347 = new ErrorObj(347, "[UBL-DOCUMENT] Hubo un problema con la fecha de referencia.");
    /*public ErrorObj ERROR_348 = new ErrorObj(348,
    "[UBL-DOCUMENT] No se encontro el valor del SUBTOTAL en la transaccion.");*/ ErrorObj ERROR_349 = new ErrorObj(349, "[UBL-DOCUMENT] Hubo un problema al generar el BillingPayment en una de las LINEAS del RESUMEN DIARIO.");
