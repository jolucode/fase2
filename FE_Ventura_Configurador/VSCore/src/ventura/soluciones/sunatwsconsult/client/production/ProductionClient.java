package ventura.soluciones.sunatwsconsult.client.production;
...
public class ProductionClient extends ProductionWSClient
{
	...
	{
		if (logger.isDebugEnabled()) {logger.debug("+getStatus() [PRODUCTION] rucComprobante: " + rucComprobante + " tipoComprobante: " + tipoComprobante + " serieComprobante: " + serieComprobante + " numeroComprobante: " + numeroComprobante);}
	...
	{
		if (logger.isDebugEnabled()) {logger.debug("+getStatusCdr() [PRODUCTION] rucComprobante: " + rucComprobante + " tipoComprobante: " + tipoComprobante + " serieComprobante: " + serieComprobante + " numeroComprobante: " + numeroComprobante);}
		
		StatusResponse response = getSecurityPort().getStatusCdr(rucComprobante, tipoComprobante, serieComprobante, numeroComprobante);
		
		if (logger.isDebugEnabled()) {logger.debug("-getStatusCdr() [PRODUCTION]");}
		return response;
	} //getStatusCdr
