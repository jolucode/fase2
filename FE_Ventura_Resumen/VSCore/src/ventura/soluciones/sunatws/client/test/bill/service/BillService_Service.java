package ventura.soluciones.sunatws.client.test.bill.service;
...
public class BillService_Service extends Service
{
    ...
    static
    {
        ...
        try
        {
        	URL baseURL = ventura.soluciones.sunatws.client.test.bill.service.BillService_Service.class.getResource(".");
            url = new URL(baseURL, "https://www.sunat.gob.pe/ol-ti-itcpgem-beta/billService?wsdl");
        }
    ...
    public BillService_Service()
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillService_Service() URL Test-WS: " + WSDL_LOCATION);}
    } //BillService_Service
    ...
    public BillService_Service(URL wsdlLocation)
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillService_Service(URL) URL Test-WS: " + wsdlLocation);}
    } //BillService_Service
    ...
    public BillService_Service(URL wsdlLocation, QName serviceName)
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillService_Service(URL, QName) URL Test-WS: " + wsdlLocation);}
    } //BillService_Service
    ...
    public BillService_Service(WebServiceFeature ... features)
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillService_Service(WebServiceFeature...) URL Test-WS: " + WSDL_LOCATION);}
    } //BillService_Service
    ...
    public BillService_Service(URL wsdlLocation, WebServiceFeature ... features)
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillService_Service(URL, WebServiceFeature...) URL Test-WS: " + wsdlLocation);}
    } //BillService_Service
    ...
    public BillService_Service(URL wsdlLocation, QName serviceName, WebServiceFeature ... features)
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillService_Service(URL, QName, WebServiceFeature...) URL Test-WS: " + wsdlLocation);}
    } //BillService_Service
    ...
    public ventura.soluciones.sunatws.client.test.bill.service.BillService getBillServicePort()
    {
        return super.getPort(BillServicePort, ventura.soluciones.sunatws.client.test.bill.service.BillService.class);
    } //getBillServicePort
     ...
     */
    @WebEndpoint(name = "BillServicePort")
    public ventura.soluciones.sunatws.client.test.bill.service.BillService getBillServicePort(WebServiceFeature... features)
    {
        return super.getPort(BillServicePort, ventura.soluciones.sunatws.client.test.bill.service.BillService.class, features);
    } //getBillServicePort
