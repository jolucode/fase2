...
import org.ventura.cpe.core.pdfcreator.object.DebitNoteObject;
...
public class PDFDebitNoteCreator extends DocumentCreator {
     ...
     */
    private PDFDebitNoteCreator(String debitNoteReportPath, String legendSubReportPath, AppProperties properties) throws PDFReportException {
     ...
     * @throws PDFReportException
     */
    public static PDFDebitNoteCreator getInstance(String debitNoteReportPath, String legendSubReportPath, AppProperties properties) throws PDFReportException {
        /*if (null == instance) {
            instance = new PDFDebitNoteCreator(debitNoteReportPath, legendSubReportPath);
        }*/
        instance = new PDFDebitNoteCreator(debitNoteReportPath, legendSubReportPath, properties);
        return instance;
    } //getInstance
     ...
     * @throws PDFReportException
     */
    public byte[] createDebitNotePDF(DebitNoteObject debitNoteObj, String docUUID) throws PDFReportException {
        if (logger.isDebugEnabled()) {
        ...
        if (null == debitNoteObj) {
            ...
            try {
                 ...
                 */
                JasperPrint iJasperPrint = JasperFillManager.fillReport(dnJasperReport, parameterMap, new JRBeanCollectionDataSource(debitNoteObj.getItemsListDynamic()));
