...
import ventura.soluciones.sunatwsconsult.client.production.service.BillConsultService;
import ventura.soluciones.sunatwsconsult.client.production.service.BillService;
import ventura.soluciones.sunatwsconsult.consumer.Consumer;
import ventura.soluciones.sunatwsconsult.factory.ISunatClient;
import ventura.soluciones.sunatwsconsult.security.HeaderHandlerResolver;
...
public abstract class ProductionWSClient implements ISunatClient
{
	...
	protected BillService getSecurityPort() throws JAXBException
	{
		...
		return service.getBillConsultServicePort();
	} //getSecurityPort
