...
public class TransaccionComprobantePago implements Serializable {
    ...
    @XmlTransient
    public List<TransaccionComprobantepagoUsuario> getTransaccionComprobantepagoUsuarioList() {
        return transaccionComprobantepagoUsuarioList;
    }

    public void setTransaccionComprobantepagoUsuarioList(List<TransaccionComprobantepagoUsuario> transaccionComprobantepagoUsuarioList) {
        this.transaccionComprobantepagoUsuarioList = transaccionComprobantepagoUsuarioList;
    }
