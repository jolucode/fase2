...
public class Configuracion {
    ...
    protected Configuracion.Erp erp;
    ...
    protected Configuracion.Jdbc jdbc;

    public Configuracion.Erp getErp() {
        return erp;
    }

    public void setErp(Configuracion.Erp erp) {
        this.erp = erp;
    }
    ...
    public Configuracion.Jdbc getJdbc() {
        return jdbc;
    }

    public void setJdbc(Configuracion.Jdbc jdbc) {
        this.jdbc = jdbc;
    }
    ...
    public static class Erp {
        ...
        @XmlElement(name = "BaseDeDatos", required = true)
    ...
    @XmlType(name = "", propOrder = {
            ...
            "paymentSubReportPath",
            "carrierGuideReportPath"
    })
    public static class Pdf {
        ...
        @XmlElement(name = "PaymentSubReportPath", required = true)
        private String paymentSubReportPath;
        /** Harol 29-03-2024 Config Tag Guia Transportista*/
        @XmlElement(name = "CarrierGuideReportPath", required = true)
        private String carrierGuideReportPath;
        /** */
        public String getPaymentSubReportPath() {
            return paymentSubReportPath;
        }

        public void setPaymentSubReportPath(String paymentSubReportPath) {
            this.paymentSubReportPath = paymentSubReportPath;
        }
         ...
         *              {@link String }
         */
        public void setCarrierGuideReportPath(String value) {
            this.carrierGuideReportPath = value;
        } //setRemissionGuideReportPath
         ...
         * {@link String }
         */
        public String getCarrierGuideReportPath() {
            return carrierGuideReportPath;
        } //getCarrierGuideReportPath
    ...
    public static class Jdbc {
        ...
        @XmlElement(name = "EstadoJdbc", required = true)
        protected Boolean estadoJdbc;

        @XmlElement(name = "ServidorBDJdbc", required = true)
        protected String servidorBDJdbc;

        @XmlElement(name = "NameUserField", required = true)
        protected String nameUserField;

        @XmlElement(name = "SqlServer", required = true)
        protected Boolean sqlServer;

        public Boolean getEstadoJdbc(){
            return estadoJdbc;
        }

        public void setEstadoJdbc(Boolean estadoJdbc){
