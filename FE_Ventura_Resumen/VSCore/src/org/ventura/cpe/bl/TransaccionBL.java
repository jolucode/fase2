...
public class TransaccionBL {
    ...
    /**
     * @return la lista de trnsacciones pendientes de respuesta. Es decir las
     * que tengan el estado [R]ecibido,[P]endiente Respuesta SUNAT, Con[S]ulta
     * Enviada
     */
    public static List<Transaccion> ListarPendientes() {
        List<Transaccion> l = TransaccionJC.findPendientes();
        return l;
    }
