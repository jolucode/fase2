...
import pe.gob.sunat.service.conose.SendSummary;
...
public class CONOSEClient extends CONOSEBasicClient {
    ...
    public String sendSummary(String fileName, byte[] contentFile, String partyType) throws IbillServiceSendSummaryMessageFaultMessage {
        ...
        org.tempuri.BillService billService = new org.tempuri.BillService();
        org.tempuri.IbillService port = billService.getBillServicePort();
        ...
        try {
            ...
            WSBindingProvider wbp = (WSBindingProvider) port;// port;
        ...
        response = port.sendSummary(fileName, contentFile,partyType); //port
