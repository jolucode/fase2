...
public class DocumentNameHandler {
	 ...
	 * @param docIdentifier
	 *            Identificador del documento (Serie y correlativo).
	...
	public String getPerceptionName(String senderRUC, String docIdentifier) {
		return MessageFormat.format(DOCUMENT_PATTERN, senderRUC,
				IUBLConfig.DOC_PERCEPTION_CODE, docIdentifier);
	} // getPerceptionName
	 ...
	 */
	public String getInvoiceName(String senderRUC, String docIdentifier) {
		return MessageFormat.format(DOCUMENT_PATTERN, senderRUC,
				IUBLConfig.DOC_INVOICE_CODE, docIdentifier);
	} // getInvoiceName
