...
import org.ventura.soluciones.pdfcreator.object.item.InvoiceItemObject;
...
public class InvoiceObject {
    ...
    public void setPerceptionPercentage(String perceptionPercentage) { this.perceptionPercentage = perceptionPercentage; }

    public List<WrapperItemObject> getItemListDynamic() {
        return itemListDynamic;
    }

    public void setItemListDynamic(List<WrapperItemObject> itemListDynamic) { this.itemListDynamic = itemListDynamic; }
    ...
    public BigDecimal getBaseImponibleRetencion() { return baseImponibleRetencion; }

    public void setBaseImponibleRetencion(BigDecimal baseImponibleRetencion) { this.baseImponibleRetencion = baseImponibleRetencion; }
    ...
    public BigDecimal getMontoRetencion() {  return montoRetencion; }

    public void setMontoRetencion(BigDecimal montoRetencion) { this.montoRetencion = montoRetencion; }
} //InvoiceObject
