...
import org.ventura.cpe.core.pdfcreator.object.InvoiceObject;
...
public class PDFInvoiceCreator extends DocumentCreator {
     ...
     */
    private PDFInvoiceCreator(String invoiceReportPath, String legendSubReportPath, AppProperties properties) throws PDFReportException {
     ...
     * @throws PDFReportException
     */
    public static PDFInvoiceCreator getInstance(String invoiceReportPath, String legendSubReportPath, AppProperties properties) throws PDFReportException {
        /*if (null == instance) {
            instance = new PDFInvoiceCreator(invoiceReportPath, legendSubReportPath);
        }*/
        instance = new PDFInvoiceCreator(invoiceReportPath, legendSubReportPath, properties);
        return instance;
    } //getInstance
     ...
     * @throws PDFReportException
     */
    public byte[] createInvoicePDF(InvoiceObject invoiceObj, String docUUID) throws PDFReportException {
        if (logger.isDebugEnabled()) {
        ...
        if (null == invoiceObj) {
            ...
            try {
                ...
                if (impresion.equalsIgnoreCase("PDF 417")) {
                 ...
                 * electronica
                 */
                JasperPrint iJasperPrint = JasperFillManager.fillReport(iJasperReport, parameterMap, new JRBeanCollectionDataSource(invoiceObj.getItemListDynamic()));
                /*
                ...
                if (logger.isInfoEnabled()) {
                    logger.info("createInvoicePDF() [" + docUUID + "] Se convirtio el PDF en bytes: " + Arrays.toString(pdfDocument));
                }
            } catch (Exception e) {
