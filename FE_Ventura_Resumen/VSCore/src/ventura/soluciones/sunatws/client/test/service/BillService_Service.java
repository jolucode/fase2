package ventura.soluciones.sunatws.client.test.service;
...
public class BillService_Service extends Service
{
    ...
    static
    {
        ...
        try
        {
        	URL baseURL = ventura.soluciones.sunatws.client.test.service.BillService_Service.class.getResource(".");
    ...
    public ventura.soluciones.sunatws.client.test.service.BillService getBillServicePort()
    {
        return super.getPort(BillServicePort, ventura.soluciones.sunatws.client.test.service.BillService.class);
    } //getBillServicePort
     ...
     */
    @WebEndpoint(name = "BillServicePort")
    public ventura.soluciones.sunatws.client.test.service.BillService getBillServicePort(WebServiceFeature... features)
    {
        return super.getPort(BillServicePort, ventura.soluciones.sunatws.client.test.service.BillService.class, features);
    } //getBillServicePort
