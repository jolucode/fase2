package org.ventura.soluciones.pdfcreator.handler;
...
import org.ventura.soluciones.pdfcreator.handler.creator.*;
import org.ventura.soluciones.pdfcreator.object.*;
import org.ventura.soluciones.pdfcreator.object.legend.LegendObject;
...
public class PDFGenerateHandler extends PDFBasicGenerateHandler {
    ...
    public static InputStream generatePDF417Code(String qrCodeData, String filePath, int width, int height, int margin) {
        ...
        try {
            ...
            objPdf417.setEncoding(Charset.forName("UTF-8"));
            int aspectRatio = 4;
    ...
    public byte[] generateRetentionPDF(UBLDocumentWRP retentionType) throws PDFReportException {
        ...
        try {
            ...
            String rutaPath = Directorio.ADJUNTOS + File.separator + "CodigoQR" + File.separator + retentionType.getRetentionType().getId().getValue() + ".png";
            ...
            f = new File(Directorio.ADJUNTOS + File.separator + "CodigoPDF417");
            rutaPath = Directorio.ADJUNTOS + File.separator + "CodigoPDF417" + File.separator + retentionType.getRetentionType().getId().getValue() + ".png";
            if (!f.exists()) {
                f.mkdirs();
            }
            ...
            /** 03-01-2024 Harol*/
            retentionObject.setsNDIRDireccion(retentionType.getTransaccion().getSNDIRDireccion());
            /** */
            /*
             * Generando el PDF de la FACTURA con la informacion recopilada.
             */
            perceptionBytes = PDFRetentionCreator.getInstance(this.documentReportPath, this.legendSubReportPath).createRetentionPDF(retentionObject, docUUID);
...
//            }
            ...
            for (int i = 0; i < invoiceType.getTransaccion().getTransaccionLineasList().size(); i++) {
                for (int j = 0; j < invoiceType.getTransaccion().getTransaccionLineasList().get(i).getTransaccionLineaImpuestosList().size(); j++) {
                    if (invoiceType.getTransaccion().getTransaccionLineasList().get(i).getTransaccionLineaImpuestosList().get(j).getTipoTributo().equalsIgnoreCase("2000")) {
                        invoiceObj.setRetentionPercentage(invoiceType.getTransaccion().getTransaccionLineasList().get(i).getTransaccionLineaImpuestosList().get(j).getPorcentaje().setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            ...
            if (retentionpercentage == null) {
                invoiceObj.setRetentionPercentage(retentionpercentage.ZERO.toString());
            }
...
//                    .getTransaccionContractdocrefList()
//                    && 0 < invoiceType.getTransaccion()
//                    .getTransaccionContractdocrefList().size()) {
//                Map<String, String> hashedMap = new HashMap<String, String>();
//                for (int i = 0; i < invoiceType.getTransaccion()
//                        .getTransaccionContractdocrefList().size(); i++) {
//                    hashedMap.put(invoiceType.getTransaccion()
//                            .getTransaccionContractdocrefList().get(i)
...
//            }
            ...
            BigDecimal docDescuentoTotal = transaccion.getDOCDescuento();
...
//            String barcodeValue = generateBarCodeInfoString(invoiceType.getInvoiceType().getID().getValue(), invoiceType.getInvoiceType().getInvoiceTypeCode().getValue(),invoiceObj.getIssueDate(), invoiceType.getInvoiceType().getLegalMonetaryTotal().getPayableAmount().getValue(), invoiceType.getInvoiceType().getTaxTotal(), invoiceType.getInvoiceType().getAccountingSupplierParty(), invoiceType.getInvoiceType().getAccountingCustomerParty(),invoiceType.getInvoiceType().getUBLExtensions());
             ...
             * Generando el PDF de la FACTURA con la informacion recopilada.
             */
            invoiceInBytes = PDFInvoiceCreator.getInstance(this.documentReportPath, this.legendSubReportPath, this.paymentDetailReportPath).createInvoicePDF(invoiceObj, docUUID);
        } catch (PDFReportException e) {
            logger.error("generateInvoicePDF() [" + this.docUUID + "] PDFReportException - ERROR: " + e.getError().getId() + "-" + e.getError().getMessage());
            throw e;
        } catch (Exception e) {
    ...
    public byte[] generateDespatchAdvicePDF(UBLDocumentWRP despatchAdvice) throws PDFReportException {
        ...
        try {
            ...
            despatchAdviceObject.setDireccionDestino(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getDireccionLlegada());
            ...
            if(despatchAdvice.getTransaccion().getDOCCodigo().equals("31")){
                despatchAdviceObject.setPlacaVehiculo(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getPlacaVehiculo());
                despatchAdviceObject.setLicenciaConducir(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getLicenciaConducir());
            }
            /** */
            ...
            /** Harol 18-06-2024 Documentos relacionados String*/
            String documentoRelacionado = "";
            for (int p=0 ; p < despatchAdvice.getTransaccion().getTransaccionDocrefersList().size() ; p++ ){
                if(documentoRelacionado.equalsIgnoreCase("")){
                    documentoRelacionado = despatchAdvice.getTransaccion().getTransaccionDocrefersList().get(p).getId();
                }else{
                    documentoRelacionado = documentoRelacionado+"; "+despatchAdvice.getTransaccion().getTransaccionDocrefersList().get(p).getId();
                }
            }
            despatchAdviceObject.setDocumentosRelacionados(documentoRelacionado);
            /** */
            ...
            despatchAdviceObject.setGrtDocumentoRemitente(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getGRT_DocumentoRemitente());
            despatchAdviceObject.setGrtNombreRazonRemitente(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getGRT_NombreRazonRemitente());
            despatchAdviceObject.setGrtDocumentoDestinatario(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getGRT_DocumentoDestinatario());
            despatchAdviceObject.setGrtNombreRazonDestinatario(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getGRT_NombreRazonDestinatario());
            despatchAdviceObject.setNroRegistroMtc(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getNroRegistroMTC());
            despatchAdviceObject.setSnDocIdentidadNro(despatchAdvice.getTransaccion().getSNDocIdentidadNro());
            despatchAdviceObject.setSnRazonSocial(despatchAdvice.getTransaccion().getSNRazonSocial());
            despatchAdviceObject.setNombreConductor(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getNombreApellidosConductor());

            despatchAdviceObject.setIndicadorTransbordoProgramado(getEstadoIndicador(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getIndicadorTransbordo()));
            despatchAdviceObject.setIndicadorRetornoVehiculoVacio(getEstadoIndicador(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getIndicadorRetornoVehiculo()));
            despatchAdviceObject.setIndicadorTransporteSubcontratado(getEstadoIndicador(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getIndicadorRegistro()));
            despatchAdviceObject.setIndicadorRetornoVehiculoEnvasesVacio(getEstadoIndicador(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getIndicadorRetorno()));
            despatchAdviceObject.setGrtIndicadorPagadorFlete(getEstadoIndicador(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getGRT_IndicadorPagadorFlete()));

            despatchAdviceObject.setGrtNumeroTUCEPrincipal(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getGRT_NumeroTUCEPrincipal());
            despatchAdviceObject.setGrtEntidadEmisoraPrincipal(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getGRT_EntidadEmisoraPrincipal());
            despatchAdviceObject.setGrtPlacaVehiculoSecundario(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getGRT_PlacaVehiculoSecundario());
            despatchAdviceObject.setGrtNumeroTUCESecuendario(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getGRT_NumeroTUCESecuendario());
            despatchAdviceObject.setGrtEntidadEmisoraSecundario(despatchAdvice.getTransaccion().getTransaccionGuiaRemision().getGRT_EntidadEmisoraSecundario());
            /***/
            ...
            String barcodeValue = generateBarCodeInfoString(despatchAdvice.getTransaccion().getDocIdentidadNro(), despatchAdvice.getTransaccion().getDOCCodigo(), despatchAdvice.getTransaccion().getDOCSerie(), despatchAdvice.getTransaccion().getDOCNumero(), null, despatchAdvice.getTransaccion().getDOCFechaEmision().toString(), "00", despatchAdvice.getTransaccion().getSNDocIdentidadTipo(), despatchAdvice.getTransaccion().getSNDocIdentidadNro(), despatchAdvice.getAdviceType().getUBLExtensions());
    ...
    /** 06-03-2024 Harol Guia Transportista Seteo Indicador*/
    private String getEstadoIndicador (String estado){
        String indicador = "NO";
        if(estado.equalsIgnoreCase("Y") || estado.equals("1")){
            indicador = "SÍ";
        }
        return indicador;
    }
    ...
    public byte[] generateBoletaPDF(UBLDocumentWRP boletaType) throws PDFReportException {
        ...
        try {
            ...
            List<TaxTotalType> taxTotal = boletaType.getBoletaType().getTaxTotal();
            for (TaxTotalType taxTotalType : taxTotal) {
                List<TaxSubtotalType> taxSubtotal = taxTotalType.getTaxSubtotal();
                for (TaxSubtotalType taxSubtotalType : taxSubtotal) {
                    TaxCategoryType taxCategory = taxSubtotalType.getTaxCategory();
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("generateBoletaPDF() [" + this.docUUID + "] Extrayendo monto de Anticipo. " + boletaType.getTransaccion().getANTICIPOMonto());
            }
...
//            String barcodeValue = generateBarCodeInfoString(invoiceType.getInvoiceType().getID().getValue(), invoiceType.getInvoiceType().getInvoiceTypeCode().getValue(),invoiceObj.getIssueDate(), invoiceType.getInvoiceType().getLegalMonetaryTotal().getPayableAmount().getValue(), invoiceType.getInvoiceType().getTaxTotal(), invoiceType.getInvoiceType().getAccountingSupplierParty(), invoiceType.getInvoiceType().getAccountingCustomerParty(),invoiceType.getInvoiceType().getUBLExtensions());
            ...
            String rutaPath = Directorio.ADJUNTOS + File.separator + "CodigoQR" + File.separator + "03" + File.separator + boletaType.getBoletaType().getID().getValue() + ".png";
            ...
            f = new File(Directorio.ADJUNTOS + File.separator + "CodigoPDF417" + File.separator + "03");
            rutaPath = Directorio.ADJUNTOS + File.separator + "CodigoPDF417" + File.separator + "03" + File.separator + boletaType.getBoletaType().getID().getValue() + ".png";
            if (!f.exists()) {
                f.mkdirs();
            }
             ...
             * Generando el PDF de la FACTURA con la informacion recopilada.
             */
            boletaInBytes = PDFBoletaCreator.getInstance(this.documentReportPath, this.legendSubReportPath).createBoletaPDF(boletaObj, docUUID);
        } catch (PDFReportException e) {
            logger.error("generateInvoicePDF() [" + this.docUUID + "] PDFReportException - ERROR: " + e.getError().getId() + "-" + e.getError().getMessage());
            throw e;
        } catch (Exception e) {
...
//            String barcodeValue = generateBarCodeInfoString(invoiceType.getInvoiceType().getID().getValue(), invoiceType.getInvoiceType().getInvoiceTypeCode().getValue(),invoiceObj.getIssueDate(), invoiceType.getInvoiceType().getLegalMonetaryTotal().getPayableAmount().getValue(), invoiceType.getInvoiceType().getTaxTotal(), invoiceType.getInvoiceType().getAccountingSupplierParty(), invoiceType.getInvoiceType().getAccountingCustomerParty(),invoiceType.getInvoiceType().getUBLExtensions());
             ...
             * Generando el PDF de la FACTURA con la informacion recopilada.
             */
            creditNoteInBytes = PDFCreditNoteCreator.getInstance(this.documentReportPath, this.legendSubReportPath, this.paymentDetailReportPath).createCreditNotePDF(creditNoteObj, docUUID);
        } catch (PDFReportException e) {
            logger.error("generateInvoicePDF() [" + this.docUUID + "] PDFReportException - ERROR: " + e.getError().getId() + "-" + e.getError().getMessage());
            throw e;
        } catch (Exception e) {
...
//                    .getDebitNoteType().getUBLExtensions());
             ...
             * recopilada.
             */
            debitNoteInBytes = PDFDebitNoteCreator.getInstance(this.documentReportPath, this.legendSubReportPath).createDebitNotePDF(debitNoteObj, docUUID);
        } catch (PDFReportException e) {
