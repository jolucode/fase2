...
@NamedQueries({
    ...
    @NamedQuery(name = "TransaccionImpuestos.findByTierRange", query = "SELECT t FROM TransaccionImpuestos t WHERE t.tierRange = :tierRange")})
public class TransaccionImpuestos implements Serializable {
    ...
    public String toString() {
        return "org.ventura.cpe.generico.dto.hb.TransaccionImpuestos[ transaccionImpuestosPK=" + transaccionImpuestosPK + " ]";
    }
