package ventura.soluciones.sunatws.client.test.cpr.service;
...
public class CPRService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
        	URL baseURL = ventura.soluciones.sunatws.client.test.cpr.service.CPRService_Service.class.getResource(".");
    ...
    public ventura.soluciones.sunatws.client.test.cpr.service.CPRService getBillServicePort() {
        return super.getPort(BillServicePort,  ventura.soluciones.sunatws.client.test.cpr.service.CPRService.class);
    }
     ...
     */
    @WebEndpoint(name = "BillServicePort")
    public  ventura.soluciones.sunatws.client.test.cpr.service.CPRService getBillServicePort(WebServiceFeature... features) {
        return super.getPort(BillServicePort,  ventura.soluciones.sunatws.client.test.cpr.service.CPRService.class, features);
    }
    ...
    public ventura.soluciones.sunatws.client.test.cpr.service.CPRService getBillServicePort0() {
        return super.getPort(BillServicePort0, ventura.soluciones.sunatws.client.test.cpr.service.CPRService.class);
    }
    ...
    public  ventura.soluciones.sunatws.client.test.cpr.service.CPRService getBillServicePort0(WebServiceFeature... features) {
        return super.getPort(BillServicePort0,  ventura.soluciones.sunatws.client.test.cpr.service.CPRService.class, features);
    }
}
