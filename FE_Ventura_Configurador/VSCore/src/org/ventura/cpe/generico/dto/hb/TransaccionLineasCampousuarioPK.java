 ...
 */
@Embeddable
public class TransaccionLineasCampousuarioPK implements Serializable {
    ...
    public TransaccionLineasCampousuarioPK() {
    }

    public TransaccionLineasCampousuarioPK(String fEId, int nroOrden, int idCampoUsuario) {
        this.fEId = fEId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TransaccionLineasCampousuarioPK)) {
            return false;
        }
        TransaccionLineasCampousuarioPK other = (TransaccionLineasCampousuarioPK) object;
    ...
    public String toString() {
        return "org.ventura.cpe.generico.dto.hb.TransaccionLineasCampousuarioPK[ fEId=" + fEId + ", nroOrden=" + nroOrden + ", idCampoUsuario=" + idCampoUsuario + " ]";
    }
