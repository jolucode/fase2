...
import org.ventura.soluciones.pdfcreator.object.CreditNoteObject;
    ...
    public byte[] createCreditNotePDF(CreditNoteObject creditNoteObj, String docUUID) throws PDFReportException {
        ...
        if (null == creditNoteObj) {
            ...
            try {
                ...
                if (VariablesGlobales.Impresion.equalsIgnoreCase("PDF 417")) {
                ...
                if (VariablesGlobales.Impresion.equalsIgnoreCase("Valor Resumen")) {
