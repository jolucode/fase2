package org.ventura.soluciones.sunatws.client.homologation.service;
...
@WebServiceClient(name = "billService",
        ...
        wsdlLocation = "https://www.sunat.gob.pe/ol-ti-itcpgem-sqa/billService?wsdl")
public class BillService_Service extends Service {
    ...
    public BillService_Service() {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("+-BillService_Service() URL Homologation-WS: " + WSDL_LOCATION);
        }
    } //BillService_Service
    ...
    public BillService_Service(URL wsdlLocation) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("+-BillService_Service(URL) URL Homologation-WS: " + wsdlLocation);
        }
    } //BillService_Service
    ...
    public BillService_Service(URL wsdlLocation, QName serviceName) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("+-BillService_Service(URL, QName) URL Homologation-WS: " + wsdlLocation);
        }
    } //BillService_Service
    ...
    public BillService_Service(WebServiceFeature... features) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("+-BillService_Service(WebServiceFeature...) URL Homologation-WS: " + WSDL_LOCATION);
        }
    } //BillService_Service
    ...
    public BillService_Service(URL wsdlLocation, WebServiceFeature... features) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("+-BillService_Service(URL, WebServiceFeature...) URL Homologation-WS: " + wsdlLocation);
        }
    } //BillService_Service
    ...
    public BillService_Service(URL wsdlLocation, QName serviceName, WebServiceFeature... features) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("+-BillService_Service(URL, QName, WebServiceFeature...) URL Homologation-WS: " + wsdlLocation);
        }
    } //BillService_Service
