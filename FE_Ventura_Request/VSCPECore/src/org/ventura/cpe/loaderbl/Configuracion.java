...
public class Configuracion {
    ...
    @XmlElement(name = "EmisorElectronico")
    private final Configuracion.EmisorElectronico emisorElectronico = new EmisorElectronico();
    ...
    @XmlElement(name = "SunatGuias")
    private final Configuracion.SunatGuias sunatGuias = new SunatGuias();

    @ToString
    public static class SunatGuias {

        @XmlElement(name = "IntegracionGuias")
        private Valor IntegracionGuias = new Valor();

        private UsuarioG usuario = new UsuarioG();

        @ToString
        public static class UsuarioG {

            private Valor usuarioGuias = new Valor();
            private Valor claveGuias = new Valor();
            private Valor clientID = new Valor();
            private Valor secretID = new Valor();
            private Valor scope = new Valor();

            public Valor getUsuarioGuias() {
                return usuarioGuias;
            }

            @XmlElement(name = "UsuarioGuias")
            public void setUsuarioGuias(Valor usuarioGuias) {
                this.usuarioGuias = usuarioGuias;
            }


            public Valor getClaveGuias() {
                return claveGuias;
            }

            @XmlElement(name = "ClaveGuias")
            public void setClaveGuias(Valor claveGuias) {
                this.claveGuias = claveGuias;
            }

            public Valor getClientID() {
                return clientID;
            }

            @XmlElement(name = "ClientID")
            public void setClientID(Valor clientID) {
                this.clientID = clientID;
            }

            public Valor getSecretID() {
                return secretID;
            }

            @XmlElement(name = "SecretID")
            public void setSecretID(Valor secretID) {
                this.secretID = secretID;
            }

            public Valor getScope() {
                return scope;
            }

            @XmlElement(name = "Scope")
            public void setScope(Valor scope) {
                this.scope = scope;
            }
        }
        ...
        public Valor getIntegracionGuias() {
            return IntegracionGuias;
        }

        public void setIntegracionGuias(Valor integracionGuias) {
            IntegracionGuias = integracionGuias;
        }
    ...
    public static class Pdf {
        ...
        private Valor invoicePaymentDetailPath = new Valor();
        ...
        public Valor getInvoicePaymentDetailPath() { return invoicePaymentDetailPath; }

        @XmlElement(name = "PaymentSubReportPath")
        public void setInvoicePaymentDetailPath(Valor invoicePaymentDetailPath) {
            this.invoicePaymentDetailPath = invoicePaymentDetailPath;
        }
    ...
    public static class Sunat {
        ...
        private Valor rutaConoseTest = new Valor();

        private Valor rutaConoseProd = new Valor();
        ...
        public Valor getRutaOseProd() { return rutaOseProd; }
        ...
        public Valor getRutaConoseProd() {  return rutaConoseProd; }

        @XmlElement(name = "RutaConoseProd")
        public void setRutaConoseProd(Valor rutaConoseProd) {
            this.rutaConoseProd = rutaConoseProd;
        }

        public Valor getRutaConoseTest() {  return rutaConoseTest; }

        @XmlElement(name = "RutaConoseTest")
        public void setRutaConoseTest(Valor rutaConoseTest) {
            this.rutaConoseTest = rutaConoseTest;
        }
    ...
    public SunatGuias getSunatGuias() {
        return sunatGuias;
    }
    ...
    public EmisorElectronico getEmisorElectronico() {
