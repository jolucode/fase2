...
public class Configuracion {
    ...
    private final Configuracion.Modulos modulos = new Modulos();
    ...
    public static class Modulos {
        ...
        public static class Modulo {
            ...
            private Valor nombre = new Valor();

            private Valor ruta = new Valor();

            public Valor getNombre() {
                return nombre;
            }

            @XmlElement(name = "Nombre")
            public void setNombre(Valor nombre) {
                this.nombre = nombre;
            }

            public Valor getRuta() {
                return ruta;
            }

            @XmlElement(name = "Ruta")
            public void setRuta(Valor ruta) {
                this.ruta = ruta;
            }
        }
    }
