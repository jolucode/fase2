...
public interface IUBLConfig {
    ...
    String TAX_TOTAL_GRT_NAME = "GRT";

    String TAX_TOTAL_EXO_NAME = "EXO";

    String TAX_TOTAL_INA_NAME = "INA";

    String TAX_TOTAL_OTH_NAME = "OTROS";
    ...
    String TAX_TOTAL_FRE_CODE = "FRE";

    String TAX_TOTAL_VAT_CODE = "VAT";
    ...
    int DECIMAL_PREPAID_PAYMENT_AMOUNT = 2;

    int DECIMAL_LEGAL_MONERARY_LINEEXTENSION = 2;

    int DECIMAL_LEGAL_MONETARY_PAYABLE_AMOUNT = 2;

    int DECIMAL_LEGAL_MONETARY_ALLOWANCE_TOTAL_AMOUNT = 2;

    int DECIMAL_LEGAL_MONETARY_TOTAL_PREPAID = 2;
    ...
    int DECIMAL_LINE_EXTENSION_AMOUNT = 2;
...
//      public static final String UBL_VERSION_ID_1_0 = "1.0";
//      public static final String UBL_VERSION_ID_21_0 = "2.1";
//      public static final String UBL_VERSION_ID_12_0 = "2.1";
    ...
    int DECIMAL_ALLOWANCECHARGE_MULTIPLIERFACTORNUMERIC = 2;
