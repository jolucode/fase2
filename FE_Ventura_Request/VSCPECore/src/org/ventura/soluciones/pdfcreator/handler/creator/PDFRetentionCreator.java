...
import org.ventura.soluciones.pdfcreator.object.RetentionObject;
    ...
    public byte[] createRetentionPDF(RetentionObject retentionObject,
        ...
        if (null == retentionObject) {
            ...
            try {
                ...
                /** 03-01-2024 Harol*/
                parameterMap.put(IPDFCreatorConfig.RECEIVER_FISCAL_ADDRESS, retentionObject.getsNDIRDireccion());
                /** */
                ...
                if (VariablesGlobales.Impresion.equalsIgnoreCase("PDF 147")) {
