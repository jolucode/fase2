package ventura.soluciones.sunatwsconsult.client.production.service;
...
public class BillConsultService extends Service
{
    ...
    static
    {
        ...
        try
        {
        	URL baseURL = ventura.soluciones.sunatwsconsult.client.production.service.BillConsultService.class.getResource(".");
    ...
    public BillConsultService()
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillConsultService() URL Production-WS: " + WSDL_LOCATION);}
    } //BillConsultService
    ...
    public BillConsultService(URL wsdlLocation)
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillConsultService(URL) URL Production-WS: " + wsdlLocation);}
    } //BillConsultService
    ...
    public BillConsultService(URL wsdlLocation, QName serviceName)
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillConsultService(URL, QName) URL Production-WS: " + wsdlLocation);}
    } //BillConsultService
    ...
    public BillConsultService(WebServiceFeature ... features)
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillConsultService(WebServiceFeature...) URL Production-WS: " + WSDL_LOCATION);}
    } //BillConsultService
    ...
    public BillConsultService(URL wsdlLocation, WebServiceFeature ... features)
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillConsultService(URL, WebServiceFeature...) URL Production-WS: " + wsdlLocation);}
    } //BillConsultService
    ...
    public BillConsultService(URL wsdlLocation, QName serviceName, WebServiceFeature ... features)
    {
        ...
        if (logger.isDebugEnabled()) {logger.debug("+-BillConsultService(URL, QName, WebServiceFeature...) URL Production-WS: " + wsdlLocation);}
    } //BillConsultService     
