...
public abstract class DocumentoINF {
    ...
    public static DocumentoINF getGetEnviarTransaccion() {
        return GetEnviarTransaccion;
    }

    public static DocumentoINF getGetEnviarConsulta() {
        return GetEnviarConsulta;
    }
    ...
    public abstract boolean ActualizarMensaje(Transaccion tc, String mensaje, String estado, ICompany Sociedad,Connection connection) throws VenturaExcepcion;

    public abstract boolean ActualizarRespuestaSUNAT(Transaccion tc, String respuesta, boolean aprobado, ICompany Sociedad, Connection connection) throws VenturaExcepcion;

    public abstract Map<String, String> AgregarAnexos(Transaccion tc, byte[] xml, byte[] pdf, byte[] cdr, Boolean borrador, ICompany Sociedad, Connection connection) throws VenturaExcepcion;

    public abstract boolean PonerEnSeguimiento(Transaccion tc, ICompany Sociedad, Connection connection) throws VenturaExcepcion;

    public abstract boolean CargarParametro(Configuracion configuracion);

    public abstract String Conectar();

    public abstract void Desconectar();

    public abstract boolean capturarCodigo(Transaccion tc, String codigoBarra, String digestValue, ICompany Sociedad, Connection connection) throws VenturaExcepcion;

    public abstract ICompany ConectarSociedad();
