...
public class TransaccionLineas implements Serializable {
    ...
    private Set<TransaccionLineasBillref> transaccionLineasBillrefList = new HashSet<>();

    @OneToMany(cascade = CascadeType.ALL, mappedBy = "transaccionLineas", fetch = FetchType.EAGER)
    private Set<TransaccionLineaImpuestos> transaccionLineaImpuestosList = new HashSet<>();
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "transaccionLineas", fetch = FetchType.EAGER)
    private Set<TransaccionLineasUsucampos> transaccionLineasUsucampos = new HashSet<>();
