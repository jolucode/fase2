...
import org.ventura.cpe.core.util.LocalDateAttributeConverter;
import org.ventura.cpe.core.util.LocalDatetimeAttributeConverter;
...
public class PublicardocWs implements Serializable {
    ...
    private LocalDateTime fechaPublicacionPortal;
