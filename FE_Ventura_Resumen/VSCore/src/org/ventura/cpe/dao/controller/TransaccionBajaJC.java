...
public class TransaccionBajaJC implements Serializable {
    ...
    public void create(TransaccionBaja transaccionBaja) throws PreexistingEntityException, Exception {
    ...
    public void edit(TransaccionBaja transaccionBaja) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
