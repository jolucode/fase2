package ventura.soluciones.sunatwsfe.config.error;
...
public class WSSunatError
{
	 ...
	 * 
	 * @param identifier
	 * 		Identificador del objeto WSSunatError.
	 */
	 ...
	 * 
	 * @return
	 * 		Retorna una nueva instancia de la clase WSSunatError.
	 */
	 ...
	 * 
	 * @return
	 * 		Retorna la instancia actual de la clase WSSunatError.
	 */
	...
	{
		if (logger.isDebugEnabled()) {logger.debug("+loadSunatErrors()" + (null != this.identifier ? " [" + this.identifier + "]" : ""));}
	...
	{
		if (logger.isDebugEnabled()) {logger.debug("+loadSunatConnectorErrors()");}
		if (!isLoaded)
		{
			/* Creando objeto MAP */
	 ...
	 * 
	 * @param faultCode
	 * 		Codigo de error de la excepcion de tipo SOAPFaultException.
	 * @return
	 * 		Retorna la informacion del error en un array.
	 */
	public String[] getSunatErrorInformation(String faultCode) 
	{
		if (logger.isDebugEnabled()) {logger.debug("+getSunatErrorInformation() faultCode=" + faultCode);}
		...
		for (Map.Entry<String, String[]> entry : sunatErrorMap.entrySet())
		{
		    ...
		    {
		    	sunatError = entry.getValue(); break;
		    }
		}
		if (logger.isDebugEnabled()) {logger.debug("-getSunatErrorInformation() sunatError: " + sunatError);}
		return sunatError;
	} //getSunatError
	...
	{
		if (logger.isDebugEnabled()) {logger.debug("+getSunatConnectorErrorInfo() faultCode=" + faultCode);}
		faultCode = getSunatFaultCode(faultCode);
		...
		if (logger.isDebugEnabled()) {logger.debug("-getSunatConnectorErrorInfo() sunatError: " + sunatError);}
		return sunatError;
	} //getSunatError
	 ...
	 * 
	 * @param faultCode
	 * 		Codigo fault de la excepcion del servicio web de Sunat.
	 * @return
	 * 		Retorna una sub cadena del codigo fault.
	 */
