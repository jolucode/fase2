...
/**
 * Esta clase contiene metodos para manipular los certificados digitales.
 *
 */
public class CertificateUtils {
    ...
    /**
     * Este metodo tranforma un certificado digital en base a su ubicacion en
     * disco, convirtiendola en bytes.
     *
...
//			throw e;
    ...
    /**
     * Este metodo verifica que la contrasenia del certificado digital pueda
     * abrirlo.
     *
     * @param certificate El certificado digital en bytes.
     * @param certificatePwd La contrasenia del certificado digital.
     * @return Retorna un valor booleano que indica si el proceso fue
     * satisfactorio o no.
     */
    ...
    public static boolean checkDigitalCertificateV2(byte[] certificate, String certificatePwd, String keystoreProvider, String keystoreType)
        ...
        try {
            if (null != certificate) {
                /** Harol 16-01-2024 ProveedorKeystore debe ser BC*/
     ...
     * KEYSTORE.
     *
     * NOTA: Se replico este metodo que viene de la clase SignerHandler, para
     * poder utilizarlo por separado y no intervenir en el proceso de hilos de
     * la Homologacion. Si yo usara este metodo para el proceso de HOMOLOGACION,
     * tendria que hacerlo sincrono (synchronized) lo cual haria que intervenga
     * en el proceso de hilos de la HOMOLOGACION.
     *
