...
public abstract class DocumentoINF {
    ...
    public static void setGetEnviarTransaccion(DocumentoINF GetEnviarTransaccion) {
        DocumentoINF.GetEnviarTransaccion = GetEnviarTransaccion;
    }
    ...
    public static void setGetEnviarConsulta(DocumentoINF GetEnviarConsulta) {
        DocumentoINF.GetEnviarConsulta = GetEnviarConsulta;
    }

    public static DocumentoINF getConector() {
        return Conector;
    }

    public static void setConector(DocumentoINF Conector) {
        DocumentoINF.Conector = Conector;
    }
