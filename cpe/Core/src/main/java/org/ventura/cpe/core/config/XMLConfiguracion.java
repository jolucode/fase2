...
public class XMLConfiguracion {
    ...
    private final XMLConfiguracion.GestorTiempo gestorTiempo = new GestorTiempo();

    @XmlElement(name = "ERP")
    private final XMLConfiguracion.Erp erp = new Erp();

    @XmlElement(name = "Jdbc")
    private final XMLConfiguracion.Jdbc jdbc = new Jdbc();

    @XmlElement(name = "UsoSunat")
    private final XMLConfiguracion.UsoSunat usoSunat = new UsoSunat();

    @XmlElement(name = "Repositorio")
    private final XMLConfiguracion.Repositorio repositorio = new Repositorio();

    @XmlElement(name = "Proxy")
    private final XMLConfiguracion.Proxy proxy = new Proxy();

    @XmlElement(name = "Directorio")
    private final XMLConfiguracion.Directorio directorio = new Directorio();

    @XmlElement(name = "Tiempos")
    private final XMLConfiguracion.Tiempos tiempos = new Tiempos();

    @XmlElement(name = "WebService")
    private final XMLConfiguracion.WebService webService = new WebService();

    @XmlElement(name = "EmisorElectronico")
    private final XMLConfiguracion.EmisorElectronico emisorElectronico = new EmisorElectronico();

    @XmlElement(name = "Impresion")
    private final XMLConfiguracion.Impresion impresion = new Impresion();

    @XmlElement(name = "CertificadoDigital")
    private final XMLConfiguracion.CertificadoDigital certificadoDigital = new CertificadoDigital();

    @XmlElement(name = "PFEConnector")
    private final XMLConfiguracion.PFEConnector pfeConnector = new PFEConnector();

    @XmlElement(name = "ResumenDiario")
    private final XMLConfiguracion.ResumenDiario resumenDiario = new ResumenDiario();

    @XmlElement(name = "General")
    private final XMLConfiguracion.General general = new General();

    @XmlElement(name = "Sunat")
    private final XMLConfiguracion.Sunat sunat = new Sunat();

    @XmlElement(name = "VersionUBL")
    private final XMLConfiguracion.VersionUBL versionUBL = new VersionUBL();

    @XmlElement(name = "Pdf")
    private final XMLConfiguracion.Pdf pdf = new Pdf();
    ...
    /** Harol 17-04-2024 JDBC XML Configuracion*/
    @ToString
    public static class Jdbc {

        private Valor estadoJdbc = new Valor();

        private Valor servidorBDJdbc = new Valor();

        private Valor nameUserField = new Valor();

        private Valor sqlServer = new Valor();

        public Valor getEstadoJdbc() {
            return estadoJdbc;
        }

        @XmlElement(name = "EstadoJdbc")
        public void setEstadoJdbc(Valor estadoJdbc) {
            this.estadoJdbc = estadoJdbc;
        }

        public Valor getServidorBDJdbc() {
            return servidorBDJdbc;
        }

        @XmlElement(name = "ServidorBDJdbc")
        public void setServidorBDJdbc(Valor servidorBDJdbc) {
            this.servidorBDJdbc = servidorBDJdbc;
        }

        public Valor getNameUserField() {
            return nameUserField;
        }

        @XmlElement(name = "NameUserField")
        public void setNameUserField(Valor nameUserField) {
            this.nameUserField = nameUserField;
        }

        public Valor getSqlServer() {
            return sqlServer;
        }

        @XmlElement(name = "SqlServer")
        public void setSqlServer(Valor sqlServer) {
