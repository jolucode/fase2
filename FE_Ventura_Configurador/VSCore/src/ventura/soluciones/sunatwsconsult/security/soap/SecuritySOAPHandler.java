package ventura.soluciones.sunatwsconsult.security.soap;
	...
	public boolean handleMessage(SOAPMessageContext context)
	{
		...
		if (outboundProperty.booleanValue())
		{
			...
			try
			{
				...
				SOAPElement security = header.addChildElement(IWSConsultConfig.WS_SECURITY_HEADER_PARENT_NAME, 
						IWSConsultConfig.WS_SECURITY_HEADER_PARENT_BASE_PFX, IWSConsultConfig.WS_SECURITY_HEADER_PARENT_VALUE);
				
				SOAPElement usernameToken = security.addChildElement(IWSConsultConfig.WS_SECURITY_SUB_UNTOKEN_NAME, 
						IWSConsultConfig.WS_SECURITY_HEADER_PARENT_BASE_PFX);
				usernameToken.addAttribute(new QName(IWSConsultConfig.WS_SECURITY_SUB_UNTOKEN_PFX), 
						IWSConsultConfig.WS_SECURITY_SUB_UNTOKEN_VALUE);
						
				SOAPElement username = usernameToken.addChildElement(IWSConsultConfig.WS_SECURITY_PARAM_USERNAME, 
						IWSConsultConfig.WS_SECURITY_HEADER_PARENT_BASE_PFX);	
				username.addTextNode(this.consumer.getRuc() + this.consumer.getUsername());
				
				SOAPElement password = usernameToken.addChildElement(IWSConsultConfig.WS_SECURITY_PARAM_PASSWORD, 
						IWSConsultConfig.WS_SECURITY_HEADER_PARENT_BASE_PFX);
				password.setAttribute(IWSConsultConfig.WS_SECURITY_COMMON_ATTRIBUTE_TYPE,
						IWSConsultConfig.WS_SECURITY_COMMON_ATRIBUTE_PWD_VALUE);
