...
/**
 * Este clase HANDLER contiene metodos para realizar el firmado electronico de
 * los documentos UBL validos por Sunat.
 *
 */
public class SignerHandler {
     ...
     *
     * El nombre del firmante tiene que ser el mismo que esta en el documento
     * UBL en el TAG SignatureType.
     *
    ...
    /**
     * Este metodo firma el documento UBL especificado en la ruta 'documentPath'
     * y retorna un objeto File con la nueva ruta del documento UBL firmado.
     *
     * @param documentPath La ruta del documento UBL sin firmar.
     * @param docUUID UUID del documento correspondiente al registro del objeto
    ...
    /**
     * Este metodo retorna el ALIAS del certificado digital, extrayendolo del
     * KEYSTORE.
     *
