...
import org.ventura.cpe.core.pdfcreator.object.CreditNoteObject;
...
public class PDFCreditNoteCreator extends DocumentCreator {
     ...
     */
    private PDFCreditNoteCreator(String creditNoteReportPath, String legendSubReportPath, AppProperties properties) throws PDFReportException {
     ...
     * @throws PDFReportException
     */
    public static PDFCreditNoteCreator getInstance(String creditNoteReportPath, String legendSubReportPath, AppProperties properties) throws PDFReportException {
        /*if (null == instance) {
            instance = new PDFCreditNoteCreator(creditNoteReportPath, legendSubReportPath);
        }*/
        instance = new PDFCreditNoteCreator(creditNoteReportPath, legendSubReportPath, properties);
        return instance;
    } //getInstance
     ...
     * @throws PDFReportException
     */
    public byte[] createCreditNotePDF(CreditNoteObject creditNoteObj, String docUUID) throws PDFReportException {
        if (logger.isDebugEnabled()) {
        ...
        if (null == creditNoteObj) {
            ...
            try {
                 ...
                 */
                JasperPrint iJasperPrint = JasperFillManager.fillReport(cnJasperReport, parameterMap, new JRBeanCollectionDataSource(creditNoteObj.getItemsListDynamic()));
