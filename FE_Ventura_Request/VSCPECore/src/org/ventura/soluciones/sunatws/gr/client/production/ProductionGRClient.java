...
import pe.gob.sunat.service.gr.StatusResponse;

import javax.activation.DataHandler;

public class ProductionGRClient extends ProductionWSGRClient {

    private static final Logger logger = Logger
            .getLogger(ProductionGRClient.class);

    @Override
    public byte[] sendBill(String fileName, DataHandler contentFile)
            throws Exception {
