 ...
 */
@WebServiceClient(name = "billService", wsdlLocation = "https://ose.tci.net.pe/ol-ti-itcpe-2/ws/billService?wsdl", targetNamespace = "http://service.sunat.gob.pe")
public class BillService_Service extends Service {
    ...
    static {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillService_Service.class.getName()).log(java.util.logging.Level.INFO, "Can not initialize the default wsdl from {0}", "https://ose.tci.net.pe/ol-ti-itcpe-2/ws/billService?wsdl");
        }
        WSDL_LOCATION = url;
    }
