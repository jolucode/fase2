package ventura.soluciones.sunatws_ose.tci.config;
...
public interface IOSEClient
{
     ...
     * @return
     * 		Retorna el CDR OSE de respuesta.
     * @throws Exception
     */
     ...
     * 
     * @param ticket
     * 		El numero de ticket de consulta.
     * @return
     * 		Retorna el objeto StatusResponse que contiene el CDR OSE de respuesta y el codigo de respuesta.
     * @throws Exception
     */
    public abstract pe.gob.sunat.service.ose_tci.StatusResponse getStatus(String ticket) throws Exception;
     ...
     * 		Numero RUC del comprobante a consultar.
     ...
     * @return
     * 		Retorna el objeto CdrStatusResponse que contiene el CDR OSE de respuesta, el codigo de respuesta 
     * 		y el mensaje de respuesta. 
     * @throws Exception
     */
    public abstract pe.gob.sunat.service.ose_tci.CdrStatusResponse getStatusCDR(String rucComprobante, 
     ...
     * 
     * @param printOption
     * 		Valor booleano que definira la habilitacion o deshabilitacion de la opcion que muestra 
     * 		la trama SOAP (request and response).
     */
