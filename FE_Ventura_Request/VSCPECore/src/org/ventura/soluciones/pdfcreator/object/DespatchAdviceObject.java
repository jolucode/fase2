 ...
 */
package org.ventura.soluciones.pdfcreator.object;
...
public class DespatchAdviceObject {
    ...
    /** 29-02-2024 harol PDF Getter & Setter Guia Transportista */
    public String getGrtTipoDocRemitente() {
        return grtTipoDocRemitente;
    }

    public void setGrtTipoDocRemitente(String grtTipoDocRemitente) {
        this.grtTipoDocRemitente = grtTipoDocRemitente;
    }

    public String getGrtDocumentoRemitente() {
        return grtDocumentoRemitente;
    }

    public void setGrtDocumentoRemitente(String grtDocumentoRemitente) {
        this.grtDocumentoRemitente = grtDocumentoRemitente;
    }

    public String getGrtNombreRazonRemitente() {
        return grtNombreRazonRemitente;
    }

    public void setGrtNombreRazonRemitente(String grtNombreRazonRemitente) {
        this.grtNombreRazonRemitente = grtNombreRazonRemitente;
    }

    public String getGrtIndicadorPagadorFlete() {
        return grtIndicadorPagadorFlete;
    }

    public void setGrtIndicadorPagadorFlete(String grtIndicadorPagadorFlete) {
        this.grtIndicadorPagadorFlete = grtIndicadorPagadorFlete;
    }

    public String getGrtTipoDocDestinatario() {
        return grtTipoDocDestinatario;
    }

    public void setGrtTipoDocDestinatario(String grtTipoDocDestinatario) {
        this.grtTipoDocDestinatario = grtTipoDocDestinatario;
    }

    public String getGrtDocumentoDestinatario() {
        return grtDocumentoDestinatario;
    }

    public void setGrtDocumentoDestinatario(String grtDocumentoDestinatario) {
        this.grtDocumentoDestinatario = grtDocumentoDestinatario;
    }

    public String getGrtNombreRazonDestinatario() {
        return grtNombreRazonDestinatario;
    }

    public void setGrtNombreRazonDestinatario(String grtNombreRazonDestinatario) {
        this.grtNombreRazonDestinatario = grtNombreRazonDestinatario;
    }
    ...
    public String getIndicadorRetornoVehiculoVacio() {
        return indicadorRetornoVehiculoVacio;
    }

    public void setIndicadorRetornoVehiculoVacio(String indicadorRetornoVehiculoVacio) {
        this.indicadorRetornoVehiculoVacio = indicadorRetornoVehiculoVacio;
    }

    public String getIndicadorTransporteSubcontratado() {
        return indicadorTransporteSubcontratado;
    }

    public void setIndicadorTransporteSubcontratado(String indicadorTransporteSubcontratado) {
        this.indicadorTransporteSubcontratado = indicadorTransporteSubcontratado;
    }

    public String getIndicadorRetornoVehiculoEnvasesVacio() {
        return indicadorRetornoVehiculoEnvasesVacio;
    }

    public void setIndicadorRetornoVehiculoEnvasesVacio(String indicadorRetornoVehiculoEnvasesVacio) {
        this.indicadorRetornoVehiculoEnvasesVacio = indicadorRetornoVehiculoEnvasesVacio;
    }

    public String getGrtNumeroTUCEPrincipal() {
        return grtNumeroTUCEPrincipal;
    }

    public void setGrtNumeroTUCEPrincipal(String grtNumeroTUCEPrincipal) {
        this.grtNumeroTUCEPrincipal = grtNumeroTUCEPrincipal;
    }

    public String getGrtEntidadEmisoraPrincipal() {
        return grtEntidadEmisoraPrincipal;
    }

    public void setGrtEntidadEmisoraPrincipal(String grtEntidadEmisoraPrincipal) {
        this.grtEntidadEmisoraPrincipal = grtEntidadEmisoraPrincipal;
    }

    public String getGrtPlacaVehiculoSecundario() {
        return grtPlacaVehiculoSecundario;
    }

    public void setGrtPlacaVehiculoSecundario(String grtPlacaVehiculoSecundario) {
        this.grtPlacaVehiculoSecundario = grtPlacaVehiculoSecundario;
    }

    public String getGrtNumeroTUCESecuendario() {
        return grtNumeroTUCESecuendario;
    }

    public void setGrtNumeroTUCESecuendario(String grtNumeroTUCESecuendario) {
        this.grtNumeroTUCESecuendario = grtNumeroTUCESecuendario;
    }

    public String getGrtEntidadEmisoraSecundario() {
        return grtEntidadEmisoraSecundario;
    }

    public void setGrtEntidadEmisoraSecundario(String grtEntidadEmisoraSecundario) {
        this.grtEntidadEmisoraSecundario = grtEntidadEmisoraSecundario;
    }

    public String getDocumentosRelacionados() {
        return documentosRelacionados;
    }

    public void setDocumentosRelacionados(String documentosRelacionados) {
    ...
    private String documentosRelacionados;
