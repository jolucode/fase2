...
public class Transaccion implements Serializable {
    ...
    private List<TransaccionGuias> transaccionGuiasList;
    ...
    private BigDecimal docMontoPercepcion;

    @Column(name = "DOC_PorPercepcion")
    private BigDecimal docPorcientoPercepcion;
    ...
    public BigDecimal getDocMontoPercepcion() {
        return docMontoPercepcion;
    }

    public void setDocMontoPercepcion(BigDecimal docMontoPercepcion) {
        this.docMontoPercepcion = docMontoPercepcion;
    }

    public BigDecimal getDocPorcientoPercepcion() {
        return docPorcientoPercepcion;
    }

    public void setDocPorcientoPercepcion(BigDecimal docPorcientoPercepcion) {
        this.docPorcientoPercepcion = docPorcientoPercepcion;
    }
    ...
    @XmlTransient
    public List<TransaccionGuias> getTransaccionGuiasList() {
        return transaccionGuiasList;
    }

    public void setTransaccionGuiasList(List<TransaccionGuias> transaccionGuiasList) {
        this.transaccionGuiasList = transaccionGuiasList;
    }
