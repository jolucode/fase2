...
public class VSFactory {
    ...
    public String GetQuery(int numero, String Tipo, String[] parametros) {
        if (Tipo.equalsIgnoreCase("4") || Tipo.equalsIgnoreCase("5") || Tipo.equalsIgnoreCase("6") || Tipo.equalsIgnoreCase("7") || Tipo.equalsIgnoreCase("8") || Tipo.equalsIgnoreCase("10")) {
            Tipo = "MSSQL";
        } else {
        ...
        String queryString = String.format(line, Arrays.toString(parametros));
