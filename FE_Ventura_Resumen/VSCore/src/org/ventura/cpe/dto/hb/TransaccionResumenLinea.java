...
public class TransaccionResumenLinea implements Serializable {
    ...
    public BigDecimal getTotalOPGratuitas() {
        return totalOPGratuitas;
    }

    public void setTotalOPGratuitas(BigDecimal totalOPGratuitas) {
    ...
    public String getDocIdModificado() {
        return docIdModificado;
    }

    public void setDocIdModificado(String docIdModificado) {
        this.docIdModificado = docIdModificado;
    }

    public String getTipoDocIdentidadModificado() {
        return tipoDocIdentidadModificado;
    }

    public void setTipoDocIdentidadModificado(String tipoDocIdentidadModificado) {
        this.tipoDocIdentidadModificado = tipoDocIdentidadModificado;
    }
    ...
    public BigDecimal getMontoTotalCobrar() {
        return montoTotalCobrar;
    }

    public void setMontoTotalCobrar(BigDecimal montoTotalCobrar) {
        this.montoTotalCobrar = montoTotalCobrar;
    }
