...
import org.ventura.cpe.core.pdfcreator.object.PerceptionObject;
...
public class PDFPerceptionCreator extends DocumentCreator {
    ...
    private PDFPerceptionCreator(String perceptionReportPath, String legendSubReportPath) throws PDFReportException {
        ...
        try {
            ...
            logger.error("PDFPerceptionCreator() FileNotFoundException - ERROR: " + e.getMessage());
            logger.error("PDFPerceptionCreator() FileNotFoundException -->" + ExceptionUtils.getStackTrace(e));
            throw new PDFReportException(e.getMessage());
        } catch (Exception e) {
            logger.error("PDFPerceptionCreator() Exception(" + e.getClass().getName() + ") - ERROR: " + e.getMessage());
            logger.error("PDFPerceptionCreator() Exception(" + e.getClass().getName() + ") -->" + ExceptionUtils.getStackTrace(e));
     ...
     */
    public static PDFPerceptionCreator getInstance(String perceptionReportPath, String legendSubReportPath) throws PDFReportException {
        /*if (null == instance) {
    ...
    public byte[] createPerceptionPDF(PerceptionObject perceptionObj, String docUUID) throws PDFReportException {
        if (logger.isDebugEnabled()) {
        ...
        if (null == perceptionObj) {
            ...
            try {
                ...
                if (StringUtils.isNotBlank(perceptionObj.getSunatTransaction())) {
                    ...
                    parameterMap.put(IPDFCreatorConfig.OPERATION_TYPE_VALUE, perceptionObj.getSunatTransaction());
                }
                ...
                legendMap.put(IPDFCreatorConfig.LEGEND_DOCUMENT_TYPE, IPDFCreatorConfig.LEGEND_PERCEPTION_DOCUMENT);
                legendMap.put(IPDFCreatorConfig.RESOLUTION_CODE_VALUE, perceptionObj.getResolutionCodeValue());
                 ...
                 * electronica
                 */
                JasperPrint iJasperPrint = JasperFillManager.fillReport(iJasperReport, parameterMap, new JRBeanCollectionDataSource(perceptionObj.getItemListDynamic()));
