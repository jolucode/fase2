...
//	{
//		long startTime = System.currentTimeMillis();
//		if (logger.isDebugEnabled()) {logger.debug("+checkInvoiceDocument() [" + this.docUUID + "]");}
//		
...
//			}
//		} //for
//		if (logger.isDebugEnabled()) {logger.debug("checkInvoiceDocument() [" + this.docUUID + "] Se extrajo los valores booleanos de los items.");}
//		
//		/* Validando Operacion GRAVADA */
//		if (logger.isDebugEnabled()) {logger.debug("checkInvoiceDocument() [" + this.docUUID + "] Validando operacion GRAVADA.");}
//		//checkOpGravada(invoiceType.getUBLExtensions().getUBLExtension(), isOpGravadaLines);
//		
//		/* Validando Operacion INAFECTA */
//		if (logger.isDebugEnabled()) {logger.debug("checkInvoiceDocument() [" + this.docUUID + "] Validando operacion INAFECTA.");}
//		//checkOpInafecta(invoiceType.getUBLExtensions().getUBLExtension(), isOpInafectaLines);
//			
//		/* Validando Operacion EXONERADA */
//		if (logger.isDebugEnabled()) {logger.debug("checkInvoiceDocument() [" + this.docUUID + "] Validando operacion EXONERADA.");}
//		//checkOpExonerada(invoiceType.getUBLExtensions().getUBLExtension(), isOpExoneradaLines);
//		
//		/* Validando Operacion GRATUITA */
//		if (logger.isDebugEnabled()) {logger.debug("checkInvoiceDocument() [" + this.docUUID + "] Validando operacion GRATUITA.");}
//		//checkOpGratuita(invoiceType.getUBLExtensions().getUBLExtension(), isOpGratuitaLines);
//			
//		/* Validando impuesto IGV */
//		if (logger.isDebugEnabled()) {logger.debug("checkInvoiceDocument() [" + this.docUUID + "] Validando impuesto IGV.");}
//		checkTaxTotalIGV(invoiceType.getTaxTotal(), isTaxIGVLines);
//		
//		/* Validando impuesto ISC */
//		if (logger.isDebugEnabled()) {logger.debug("checkInvoiceDocument() [" + this.docUUID + "] Validando impuesto ISC.");}
...
//		 * de DESCUENTO TOTAL.
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkInvoiceDocument() [" + this.docUUID + "] Validando DESCUENTO DE LINEA con DESCUENTO TOTAL.");}
...
//		 * DESCUENTO TOTAL.
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkInvoiceDocument() [" + this.docUUID + "] Validando DESCUENTO GLOBAL con DESCUENTO TOTAL.");}
...
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkInvoiceDocument() [" + this.docUUID + "] Validando MONTOS de TOTALES.");}
//		checkAdditionalMonetaryTotals(invoiceType.getUBLExtensions().getUBLExtension());
//		if (logger.isDebugEnabled()) {logger.debug("-checkInvoiceDocument() [" + this.docUUID + "] TIME: " + (System.currentTimeMillis() - startTime) + " ms");}
...
//	{
//		long startTime = System.currentTimeMillis();
//		if (logger.isDebugEnabled()) {logger.debug("+checkBoletaDocument() [" + this.docUUID + "]");}
//		
//		boolean isOpGravadaLines = false;
//		boolean isOpInafectaLines = false;
//		boolean isOpExoneradaLines = false;
...
//			}
//		} //for
//		if (logger.isDebugEnabled()) {logger.debug("checkBoletaDocument() [" + this.docUUID + "] Se extrajo los valores booleanos de los items.");}
//
//		/* Validando Operacion GRAVADA */
//		if (logger.isDebugEnabled()) {logger.debug("checkBoletaDocument() [" + this.docUUID + "] Validando operacion GRAVADA.");}
//		//checkOpGravada(boletaType.getUBLExtensions().getUBLExtension(), isOpGravadaLines);
//		
//		/* Validando Operacion INAFECTA */
//		if (logger.isDebugEnabled()) {logger.debug("checkBoletaDocument() [" + this.docUUID + "] Validando operacion INAFECTA.");}
//		//checkOpInafecta(boletaType.getUBLExtensions().getUBLExtension(), isOpInafectaLines);
//			
//		/* Validando Operacion EXONERADA */
//		if (logger.isDebugEnabled()) {logger.debug("checkBoletaDocument() [" + this.docUUID + "] Validando operacion EXONERADA.");}
//		//checkOpExonerada(boletaType.getUBLExtensions().getUBLExtension(), isOpExoneradaLines);
//		
//		/* Validando Operacion GRATUITA */
//		if (logger.isDebugEnabled()) {logger.debug("checkBoletaDocument() [" + this.docUUID + "] Validando operacion GRATUITA.");}
//		//checkOpGratuita(boletaType.getUBLExtensions().getUBLExtension(), isOpGratuitaLines);
//			
//		/* Validando impuesto IGV */
//		if (logger.isDebugEnabled()) {logger.debug("checkBoletaDocument() [" + this.docUUID + "] Validando impuesto IGV.");}
//		checkTaxTotalIGV(boletaType.getTaxTotal(), isTaxIGVLines);
//		
//		/* Validando impuesto ISC */
//		if (logger.isDebugEnabled()) {logger.debug("checkBoletaDocument() [" + this.docUUID + "] Validando impuesto ISC.");}
...
//		 * de DESCUENTO TOTAL.
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkBoletaDocument() [" + this.docUUID + "] Validando DESCUENTO DE LINEA con DESCUENTO TOTAL.");}
...
//		 * DESCUENTO TOTAL.
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkBoletaDocument() [" + this.docUUID + "] Validando DESCUENTO GLOBAL con DESCUENTO TOTAL.");}
//		checkGlobalDiscount(boletaType.getUBLExtensions().getUBLExtension(), boletaType.getLegalMonetaryTotal().getAllowanceTotalAmount());
//		
//		/*
//		 * Validando MONTOS de TOTALES del comprobante de pago.
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkBoletaDocument() [" + this.docUUID + "] Validando MONTOS de TOTALES.");}
//		checkAdditionalMonetaryTotals(boletaType.getUBLExtensions().getUBLExtension());
//		if (logger.isDebugEnabled()) {logger.debug("-checkBoletaDocument() [" + this.docUUID + "] TIME: " + (System.currentTimeMillis() - startTime) + " ms");}
//	} //checkBoletaDocument
    /**
     * Este metodo realiza la verificacion de los TAG's del documento UBL de
...
//	{
//		long startTime = System.currentTimeMillis();
//		if (logger.isDebugEnabled()) {logger.debug("+checkCreditNoteDocument() [" + this.docUUID + "]");}
//		
//		boolean isOpGravadaLines = false;
//		boolean isOpInafectaLines = false;
//		boolean isOpExoneradaLines = false;
...
//			}
//		} //for
//		if (logger.isDebugEnabled()) {logger.debug("checkCreditNoteDocument() [" + this.docUUID + "] Se extrajo los valores booleanos de los items.");}
//		
//		/* Validando Operacion GRAVADA */
//		if (logger.isDebugEnabled()) {logger.debug("checkCreditNoteDocument() [" + this.docUUID + "] Validando operacion GRAVADA.");}
//		//checkOpGravada(creditNoteType.getUBLExtensions().getUBLExtension(), isOpGravadaLines);
//		
//		/* Validando Operacion INAFECTA */
//		if (logger.isDebugEnabled()) {logger.debug("checkCreditNoteDocument() [" + this.docUUID + "] Validando operacion INAFECTA.");}
//		//checkOpInafecta(creditNoteType.getUBLExtensions().getUBLExtension(), isOpInafectaLines);
//			
//		/* Validando Operacion EXONERADA */
//		if (logger.isDebugEnabled()) {logger.debug("checkCreditNoteDocument() [" + this.docUUID + "] Validando operacion EXONERADA.");}
//		//checkOpExonerada(creditNoteType.getUBLExtensions().getUBLExtension(), isOpExoneradaLines);
//		
//		/* Validando Operacion GRATUITA */
//		if (logger.isDebugEnabled()) {logger.debug("checkCreditNoteDocument() [" + this.docUUID + "] Validando operacion GRATUITA.");}
//		//checkOpGratuita(creditNoteType.getUBLExtensions().getUBLExtension(), isOpGratuitaLines);
//			
//		/* Validando impuesto IGV */
//		if (logger.isDebugEnabled()) {logger.debug("checkCreditNoteDocument() [" + this.docUUID + "] Validando impuesto IGV.");}
//		checkTaxTotalIGV(creditNoteType.getTaxTotal(), isTaxIGVLines);
//		
//		/* Validando impuesto ISC */
//		if (logger.isDebugEnabled()) {logger.debug("checkCreditNoteDocument() [" + this.docUUID + "] Validando impuesto ISC.");}
...
//		 * DESCUENTO TOTAL.
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkCreditNoteDocuments() [" + this.docUUID + "] Validando DESCUENTO GLOBAL con DESCUENTO TOTAL.");}
...
//		 * Validando MONTOS de TOTALES del comprobante de pago.
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkCreditNoteDocuments() [" + this.docUUID + "] Validando MONTOS de TOTALES.");}
...
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkCreditNoteDocuments() [" + this.docUUID + "] Validando el TIPO DE NOTA DE CREDITO.");}
...
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkCreditNoteDocuments() [" + this.docUUID + "] Validando el CODIGO del DOCUMENTO DE REFENCIA.");}
//		checkReferenceDocumentCode(creditNoteType.getBillingReference());
//		if (logger.isDebugEnabled()) {logger.debug("-checkCreditNoteDocument() [" + this.docUUID + "] TIME: " + (System.currentTimeMillis() - startTime) + " ms");}
...
//	{
//		long startTime = System.currentTimeMillis();
//		if (logger.isDebugEnabled()) {logger.debug("+checkDebitNoteDocument() [" + this.docUUID + "]");}
//		
//		boolean isOpGravadaLines = false;
//		boolean isOpInafectaLines = false;
//		boolean isOpExoneradaLines = false;
...
//			}
//		} //for
//		if (logger.isDebugEnabled()) {logger.debug("checkDebitNoteDocument() [" + this.docUUID + "] Se extrajo los valores booleanos de los items.");}
//		
//		/* Validando Operacion GRAVADA */
//		if (logger.isDebugEnabled()) {logger.debug("checkDebitNoteDocument() [" + this.docUUID + "] Validando operacion GRAVADA.");}
//		//checkOpGravada(debitNoteType.getUBLExtensions().getUBLExtension(), isOpGravadaLines);
//		
//		/* Validando Operacion INAFECTA */
//		if (logger.isDebugEnabled()) {logger.debug("checkDebitNoteDocument() [" + this.docUUID + "] Validando operacion INAFECTA.");}
//		//checkOpInafecta(debitNoteType.getUBLExtensions().getUBLExtension(), isOpInafectaLines);
//			
//		/* Validando Operacion EXONERADA */
//		if (logger.isDebugEnabled()) {logger.debug("checkDebitNoteDocument() [" + this.docUUID + "] Validando operacion EXONERADA.");}
//		//checkOpExonerada(debitNoteType.getUBLExtensions().getUBLExtension(), isOpExoneradaLines);
//		
//		/* Validando Operacion GRATUITA */
//		if (logger.isDebugEnabled()) {logger.debug("checkDebitNoteDocument() [" + this.docUUID + "] Validando operacion GRATUITA.");}
//		//checkOpGratuita(debitNoteType.getUBLExtensions().getUBLExtension(), isOpGratuitaLines);
//			
//		/* Validando impuesto IGV */
//		if (logger.isDebugEnabled()) {logger.debug("checkDebitNoteDocument() [" + this.docUUID + "] Validando impuesto IGV.");}
//		checkTaxTotalIGV(debitNoteType.getTaxTotal(), isTaxIGVLines);
//		
//		/* Validando impuesto ISC */
//		if (logger.isDebugEnabled()) {logger.debug("checkDebitNoteDocument() [" + this.docUUID + "] Validando impuesto ISC.");}
...
//		 * DESCUENTO TOTAL.
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkDebitNoteDocument() [" + this.docUUID + "] Validando DESCUENTO GLOBAL con DESCUENTO TOTAL.");}
...
//		 * Validando MONTOS de TOTALES del comprobante de pago.
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkDebitNoteDocument() [" + this.docUUID + "] Validando MONTOS de TOTALES.");}
...
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkDebitNoteDocument() [" + this.docUUID + "] Validando el TIPO DE NOTA DE CREDITO.");}
...
//		 * A. CATALOGO No.01: Codigo de Tipo de documento.
//		 */
//		if (logger.isDebugEnabled()) {logger.debug("checkDebitNoteDocument() [" + this.docUUID + "] Validando el CODIGO del DOCUMENTO DE REFENCIA.");}
//		checkReferenceDocumentCode(debitNoteType.getBillingReference());
//		if (logger.isDebugEnabled()) {logger.debug("-checkDebitNoteDocument() [" + this.docUUID + "] TIME: " + (System.currentTimeMillis() - startTime) + " ms");}
