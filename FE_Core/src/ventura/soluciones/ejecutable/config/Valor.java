...
public class Valor {
    ...
    public String normalValue() throws RuntimeException {
        value = Optional.ofNullable(value).orElseThrow(() -> new RuntimeException("No se pudo cargar el valor del parametro."));
