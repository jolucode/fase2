...
import org.ventura.cpe.core.pdfcreator.object.BoletaObject;
...
public class PDFBoletaCreator extends DocumentCreator {
     ...
     */
    private PDFBoletaCreator(String boletaReportPath, String legendSubReportPath, AppProperties properties) throws PDFReportException {
     ...
     * @throws PDFReportException
     */
    public static PDFBoletaCreator getInstance(String boletaReportPath, String legendSubReportPath, AppProperties properties) throws PDFReportException {
        /*if (null == instance) {
            instance = new PDFBoletaCreator(boletaReportPath, legendSubReportPath);
        }*/
        instance = new PDFBoletaCreator(boletaReportPath, legendSubReportPath, properties);
        return instance;
    } //getInstance
     ...
     * @throws PDFReportException
     */
    public byte[] createBoletaPDF(BoletaObject boletaObj, String docUUID) throws PDFReportException {
        if (logger.isDebugEnabled()) {
        ...
        if (null == boletaObj) {
            ...
            try {
                 ...
                 */
                JasperPrint iJasperPrint = JasperFillManager.fillReport(bJasperReport, parameterMap, new JRBeanCollectionDataSource(boletaObj.getItemsDynamic()));
                ...
                if (logger.isInfoEnabled()) {
                    logger.info("createBoletaPDF() [" + docUUID + "] Se convirtio el PDF en bytes: " + pdfDocument);
                }
            } catch (Exception e) {
