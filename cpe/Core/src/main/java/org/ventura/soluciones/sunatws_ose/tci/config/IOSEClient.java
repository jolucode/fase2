package org.ventura.soluciones.sunatws_ose.tci.config;
...
public interface IOSEClient {
     ...
     * @throws Exception
     */
    public abstract pe.gob.sunat.service.ose_tci.CdrStatusResponse getStatusCDR(String rucComprobante, String tipoComprobante, String serieComprobante, Integer numeroComprobante) throws Exception;
