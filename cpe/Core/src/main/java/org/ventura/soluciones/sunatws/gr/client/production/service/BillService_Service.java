...
@WebServiceClient(name = "billService",
        wsdlLocation = "https://e-guiaremision.sunat.gob.pe/ol-ti-itemision-guia-gem/billService?wsdl",
...
public class BillService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("https://e-guiaremision.sunat.gob.pe/ol-ti-itemision-guia-gem/billService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BillService_Service.class.getName())
                    .log(java.util.logging.Level.INFO,
                            "Can not initialize the default wsdl from {0}", "https://e-guiaremision.sunat.gob.pe/ol-ti-itemision-guia-gem/billService?wsdl");
        }
        WSDL_LOCATION = url;
    }
