...
public class BillService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
        	URL  baseURL = ventura.soluciones.sunatwsfe.client.test.service.BillService_Service.class.getResource(".");
    ...
    public ventura.soluciones.sunatwsfe.client.test.service.BillService getBillServicePort() {
        return super.getPort(BillServicePort, ventura.soluciones.sunatwsfe.client.test.service.BillService.class);
    }
     ...
     */
    @WebEndpoint(name = "BillServicePort")
    public ventura.soluciones.sunatwsfe.client.test.service.BillService getBillServicePort(WebServiceFeature... features) {
        return super.getPort(BillServicePort, ventura.soluciones.sunatwsfe.client.test.service.BillService.class, features);
    }
