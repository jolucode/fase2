 ...
 */
@WebServiceClient(name = "billService", wsdlLocation = "https://e-beta.sunat.gob.pe/ol-ti-itemision-guia-gem-beta/billService?wsdl", targetNamespace = "http://service.gem.factura.comppago.registro.servicio.sunat.gob.pe/")
public class BillService_Service extends Service {
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseURL, "https://e-beta.sunat.gob.pe/ol-ti-itemision-guia-gem-beta/billService?wsdl");
        } catch (MalformedURLException e) {
            logger.error("static() Can not initialize the default wsdl from 'https://e-beta.sunat.gob.pe/ol-ti-itemision-guia-gem-beta/billService?wsdl'");
