...
import org.ventura.cpe.core.pdfcreator.object.RetentionObject;
...
public class PDFRetentionCreator extends DocumentCreator {
    ...
    private PDFRetentionCreator(String retentionReportPath, String legendSubReportPath, AppProperties properties) throws PDFReportException {
        ...
        try {
            ...
            InputStream inputStream = new BufferedInputStream(new FileInputStream(retentionTemplate));
            ...
            logger.error("PDFRetentionCreator() FileNotFoundException - ERROR: " + e.getMessage());
            logger.error("PDFRetentionCreator() FileNotFoundException -->" + ExceptionUtils.getStackTrace(e));
            throw new PDFReportException(e.getMessage());
        } catch (Exception e) {
            logger.error("PDFRetentionCreator() Exception(" + e.getClass().getName() + ") - ERROR: " + e.getMessage());
            logger.error("PDFRetentionCreator() Exception(" + e.getClass().getName() + ") -->" + ExceptionUtils.getStackTrace(e));
     ...
     */
    public static PDFRetentionCreator getInstance(String retentionReportPath, String legendSubReportPath, AppProperties properties) throws PDFReportException {
        /*if (null == instance) {
         instance = new PDFRetentionCreator(retentionReportPath,legendSubReportPath);
         }*/
        instance = new PDFRetentionCreator(retentionReportPath, legendSubReportPath, properties);
        return instance;
    }
     ...
     * @throws PDFReportException
     */
    public byte[] createRetentionPDF(RetentionObject retentionObject, String docUUID) throws PDFReportException {
        ...
        if (null == retentionObject) {
            ...
            try {
                ...
                if (StringUtils.isNotBlank(retentionObject.getSunatTransaction())) {
                ...
                String impresion = properties.getImpresion().getPdf();
                if (impresion.equalsIgnoreCase("Codigo QR")) {
                    parameterMap.put(IPDFCreatorConfig.CODEQR, retentionObject.getCodeQR());
                } else {
                    parameterMap.put(IPDFCreatorConfig.CODEQR, null);
                }

                if (impresion.equalsIgnoreCase("PDF 147")) {
                ...
                if (impresion.equalsIgnoreCase("Valor Resumen")) {
