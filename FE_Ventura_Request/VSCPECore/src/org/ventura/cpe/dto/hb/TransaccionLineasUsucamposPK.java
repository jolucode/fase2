...
public class TransaccionLineasUsucamposPK implements Serializable {
    ...
    public TransaccionLineasUsucamposPK() {
    }

    public TransaccionLineasUsucamposPK(String fEId, int nroOrden, int uSUCMPId) {
        this.fEId = fEId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TransaccionLineasUsucamposPK)) {
            return false;
        }
        TransaccionLineasUsucamposPK other = (TransaccionLineasUsucamposPK) object;
    ...
    public String toString() {
        return "org.ventura.cpe.dto.hb.TransaccionLineasUsucamposPK[ fEId=" + fEId + ", nroOrden=" + nroOrden + ", uSUCMPId=" + uSUCMPId + " ]";
    }
