...
public class TransaccionLineaImpuestos implements Serializable {
    ...
    public TransaccionLineaImpuestos(String fEId, int lineId, int nroOrden) {
        this.transaccionLineaImpuestosPK = new TransaccionLineaImpuestosPK(fEId, lineId, nroOrden);
    }
    ...
    public String toString() {
        return "org.ventura.cpe.generico.dto.hb.TransaccionLineaImpuestos[ transaccionLineaImpuestosPK=" + transaccionLineaImpuestosPK + " ]";
    }
