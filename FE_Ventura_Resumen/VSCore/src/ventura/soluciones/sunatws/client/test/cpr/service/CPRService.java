...
public interface CPRService {
	 ...
	 * @param contentFile
	 * 		The ZIP attachment file.
	 * @return
	 * 		Returns the CDR response by Sunat.
	 */
	 ...
	 * 
	 * @param ticket
	 * 		The ticket of request.
	 * @return
	 * 		Returns an object than contains the response code an the CDR response.
	 */
