package ventura.soluciones.sunatws.factory.impl;
...
import ventura.soluciones.sunatws.client.homologation.HomologationClient;
import ventura.soluciones.sunatws.client.test.TestClient;
import ventura.soluciones.sunatws.config.ISunatConfig;
import ventura.soluciones.sunatws.factory.ISunatClient;
import ventura.soluciones.sunatws.factory.SunatClientFactory;
...
public final class SunatClientFactoryImpl extends SunatClientFactory
{
	...
	public ISunatClient getSunatClient(String clientName,String documentType) throws ConfigurationException
	{
		...
		{
			if (logger.isInfoEnabled()) {logger.info("getSunatClient() Create a HOMOLOGATION_CLIENT.");}
		...
		else if (clientName.equalsIgnoreCase(ISunatConfig.PRODUCTION_CLIENT))
		{
			if (logger.isInfoEnabled()) {logger.info("getSunatClient() Create a PRODUCTION_CLIENT.");}
				...
				sunatClient = new ventura.soluciones.sunatws.client.production.ProductionClient();
